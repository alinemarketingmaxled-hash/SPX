...
/* POLAROIDES · as fotos entram por data-fonte, como o resto do site, e só
   quando o mural chega perto da tela. São oito fotos: baixadas no carregamento,
   competiriam com a foto do cabeçalho, que é o maior elemento pintado. */
(function polaroides(){
  var grade = $('.pol-grade');
  if(!grade) return;
  aoAproximar(grade, function(){
    $$('img[data-fonte]', grade).forEach(function(im){
      im.src = im.dataset.fonte;
      im.removeAttribute('data-fonte');
    });
  });
