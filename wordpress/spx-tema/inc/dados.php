  ...
  return [
    ...
    'servicos' => [
      [
        ...
        'descricao' => 'Planejamento, gerenciamento e execução de obras corporativas em São Paulo: escritórios e sedes, com engenharia própria do levantamento à entrega.',
    ...
    'temas' => [
      [
        'A empresa',
        ['O que a SPX Engenharia faz?', 'A SPX atende empresas?', 'A SPX atende São Paulo?', 'Quem responde tecnicamente pela obra?'],
      ],
      [
        'O que executamos',
        ['A SPX executa obras corporativas?', 'A SPX trabalha com retrofit?', 'A SPX executa reforma de escritório?', 'A SPX faz gerenciamento de obras?'],
      ],
      [
